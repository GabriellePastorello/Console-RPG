...
namespace Console_RPG
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nCongrats! You have defeated Ebony, the leader of the dragons of Cinder Mountain! You return back home a hero! Hopefully, the dragons will be eliminated altogether...");
